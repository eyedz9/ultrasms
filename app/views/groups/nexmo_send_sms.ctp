...
<?php echo $this->Form->create('nexmos', array('controller'=> 'nexmos', 'action'=> 'sendsms/1', 'id' => 'sendMsgForm', 'onsubmit'=>' return validate()'));?>
	...
	<label>Enter a phone number</label>
		<?php echo $this->Form->input('phone_number', array('class' =>'form-control','label' => false,'div' => false,'value'=>$phoneno));?>
	</div>	
	<div class="form-group">
	<label>Message</label>
...
<br>
Purchase Number to use this feature by <b><?php echo $this->Html->link('Get Number', array('controller' =>'nexmos', 'action' =>'searchcountry'), array('class' => 'nyroModal' ,'style'=>'color:#ff0000;'))?>.</b><br />
