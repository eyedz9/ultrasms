...
class ValidationHelper extends Helper {
  ...
  function rules($modelNames, $options=array()) {
    ...
    $formId = 'form';
	$validationBlock = 'validate';
    if ($options['formId']) {
      //$formId = '#' . $formName;//vinod commented this line on 4th Dec
      $formId = '#' . $options['formId'];
    }
	if (isset($options['validationBlock'])) {
      //$formId = '#' . $formName;//vinod commented this line on 4th Dec
      $validationBlock =  'validate'.$options['validationBlock'];
    }
    ...
    foreach($modelNames as $modelName) {
      ...
      foreach ($model->$validationBlock as $field => $validators) {
