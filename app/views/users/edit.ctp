						...
						<?php echo $this->Form->input('id'); ?>
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="input">
										<!--<?php echo $this->Form->input('User.email',array('div'=>false,'label'=>false, 'class' => 'form-control')); ?>-->
								...
								<div class="form-group">
									...
									<div class="input">
										<!--<?php echo $this->Form->input('User.paypal_email',array('div'=>false,'label'=>false, 'class' => 'form-control')); ?>-->
<?php echo $this->Form->text('User.paypal_email',array('div'=>false,'label'=>false, 'class' => 'form-control', 'type' => 'email')); ?>
								...
								<div class="form-group">
									...
									<div class="input">
										<!--<?php echo $this->Form->input('User.voicemailnotifymail',array('div'=>false,'label'=>false, 'class' => 'form-control')); ?>-->
...
<input type="file" id="User.mp3" name="data[User][mp3]" onclick="check_image()"/>
										<audio class="audio" controls="controls" style="height: 18px;margin-top:10px;width:20%">
