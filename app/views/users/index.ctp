<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('sms_balance');?></th>
			<th><?php echo $this->Paginator->sort('voice_balance');?></th>
			<th><?php echo $this->Paginator->sort('assigned_number');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $user['User']['assigned_number']; ?>&nbsp;</td>
