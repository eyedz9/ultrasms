...
'Zimbabwe'=>'Zimbabwe');
		...
		echo $this->Form->input('sms_balance');
                if(API_TYPE !=2){
		   echo $this->Form->input('voice_balance');
		   echo $this->Form->input('assigned_number', array('label' => 'Virtual Phone Number'));
		}
                echo $this->Form->input('timezone',array('type' =>'select', 'div'=>false, 'options'=>$Option3, 'style'=>'margin-bottom:20px'));
                echo $this->Form->input('user_country',array('label'=>'Country','type' =>'select', 'div'=>false, 'options'=>$Option4, 'style'=>'margin-bottom:20px'));
		echo $this->Form->input('active', array('label'=>'Status', 'type' =>'select' ,'options' => array('0' => 'Inactive', '1' => 'Active')));
		if(API_TYPE==2){
