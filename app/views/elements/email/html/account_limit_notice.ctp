...
<p>
A user(information below) just tried creating an account with <?php echo SITENAME ?> and could not because you have reached your active accounts limit. You will need to upgrade your level with <a href="http://www.ultrasmsscript.com">ultrasmsscript.com</a>. Please contact <a href="mailto:sales@ultrasmsscript.com">sales@ultrasmsscript.com</a> to upgrade your level. 
</p>
