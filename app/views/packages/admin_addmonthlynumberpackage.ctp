...
<?php echo $this->Form->create('Package');?>
	<fieldset>
		<legend><?php __('Add Secondary Number Packages'); ?></legend>
	<?php 
...
'Zambia'=>'Zambia',
'Zimbabwe'=>'Zimbabwe');
                echo $this->Form->input('plan',array('type'=>'text','label'=>'<strong>Plan ID</strong>'));
		echo $this->Form->input('package_name');
		echo $this->Form->input('amount');
		echo $this->Form->input('total_secondary_numbers');
