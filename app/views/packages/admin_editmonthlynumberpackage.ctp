...
<?php echo $this->Form->create('Package');?>
	<fieldset>
		<legend><?php __('Edit Monthly Number Package'); ?></legend>
	<?php
...
'Zambia'=>'Zambia',
'Zimbabwe'=>'Zimbabwe');
		echo $this->Form->input('MonthlyNumberPackage.id');
                echo $this->Form->input('MonthlyNumberPackage.plan',array('type'=>'text','label'=>'<strong>Plan ID</strong>'));
		echo $this->Form->input('MonthlyNumberPackage.package_name');
		echo $this->Form->input('MonthlyNumberPackage.amount');
		echo $this->Form->input('MonthlyNumberPackage.total_secondary_numbers');
		echo $this->Form->input('MonthlyNumberPackage.country',array('type' =>'select','div'=>false,'label'=>'<strong>Country</strong>', 'options'=>$Option4));
		echo '<br/><br/>';		
		echo $form->input('MonthlyNumberPackage.status',array('type'=>'select','options'=>$Option));
