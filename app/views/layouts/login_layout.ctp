...
<html lang="en">
    ...
    <head>
       ...
       <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo SITE_URL;?>/assets/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo SITE_URL;?>/assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo SITE_URL;?>/assets/pages/css/login-4.min.css" rel="stylesheet" type="text/css" />
	...
	<div id="content">
        ...
        <script src="<?php echo SITE_URL;?>/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo SITE_URL;?>/assets/pages/scripts/login-4.min.js" type="text/javascript"></script>
	</body>
</html>