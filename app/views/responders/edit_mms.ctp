...
<div class="loginbox">
	<div class="loginner">
		<?php echo $this->Form->create('Responder',array('action'=> 'edit_mms','enctype'=>'multipart/form-data'));?>
...
<?php echo $this->Form->input('Responder.systemmsg',array('div'=>false,'label'=>false, 'class' => 'textarea','id'=>'message','maxlength'=>'148','rows'=>'3','cols'=>46,'value'=>'STOP to end','readonly'=>'readonly'))?>
		...
		<img src="<?php echo $responder_arr['Responder']['image_url'];?>" width="80px" height="80px;""/>
...
<div class="feildbox">
		...
		<div class="feildbox">
			<?php echo $this->Form->submit('Update',array('div'=>false,'class'=>'inputbutton'));?>
