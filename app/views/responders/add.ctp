...
<!--***********************-->
							...
							<div class="form-group" style="margin-top:0px">
								...
								<?php echo $this->Form->input('Responder.message1',array('div'=>false,'label'=>false, 'class' => 'form-control' ,'id'=>'message1','maxlength'=>'148','rows'=>'6','cols'=>46,'onKeyup' =>'return update1()'))?>
								<div id='counter' style="margin-top:10px">Remaining Characters&nbsp;
									<script type="text/javascript">
										document.write("<input type=text class='form-control input-small' name=limit1 id=limit1 size=4 readonly value="+count+">");
									</script>
								</div>
								Special characters not allowed such as ~ [ ] ; "dfd
							</div>
						</div>
					<?php  } ?>	
					<div class="form-group">
