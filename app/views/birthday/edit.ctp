...
<div style="margin-bottom:10px">
						...
						<div class="form-group">
							...
							<?php echo $this->Form->input('Birthday.message',array('div'=>false,'label'=>false, 'class' => 'form-control','id'=>'message','maxlength'=>'148','rows'=>'6','cols'=>46,'onKeyup' =>'return update()'))?>
						...
						<div id='textmsg' style="display:none;">
							<div class="form-group">
								<label>Birthday Message<span class="required_star"></label>
								<?php echo $this->Form->input('Birthday.message',array('div'=>false,'label'=>false, 'class' => 'form-control','id'=>'message','maxlength'=>'148','rows'=>'6','cols'=>46,'onKeyup' =>'return update()','value'=>$birthday['Birthday']['message']))?>
								<div id='counter' style="margin-top:10px">Remaining Characters&nbsp;<script type="text/javascript">
								document.write("<input type=text  class='form-control input-small'  name=limit id=limit size=4 readonly value="+count+">");
								</script></div>
								Special characters not allowed such as ~ [ ] ; "
...
<input type="hidden" name="data[Birthday][check_img_validation]"  id="check_img_validation" value="0" />
                                                        ...
                                                        <div style="width: 200px; height: 150px;" class="fileinput-new thumbnail">
                                                            <img alt="" src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=new+image"> </div>
...
<div style="max-width: 200px; max-height: 150px; line-height: 10px;" class="fileinput-exists thumbnail" ><img class="thumbnail" src="<?php echo $birthday['Birthday']['image_url']; ?>" style="max-width: 190px; max-height: 140px;margin-bottom:0;border:0;padding:0" /></div>
							...
							<div class="form-group" style="margin-top:0px">
								<label>Birthday Message</label>
									<?php echo $this->Form->input('Birthday.message1',array('div'=>false,'label'=>false, 'class' => 'form-control','id'=>'message1','maxlength'=>'148','rows'=>'6','cols'=>46,'onKeyup' =>'return update1()','value'=>$birthday['Birthday']['message']))?>
									<div id='counter' style="margin-top:10px">Remaining Characters&nbsp;<script type="text/javascript">
						...
						<div class="form-group">
							<label>Mandatory Appended Message<span class="required_star"></label>
								<?php echo $this->Form->input('Birthday.systemmsg',array('div'=>false,'label'=>false, 'class' => 'form-control input-small','id'=>'message','maxlength'=>'148','rows'=>'2','cols'=>46,'value'=>'STOP to end','readonly'=>'readonly','style'=>'color:#808080'))?>
						</div>
						<div class="form-group">
