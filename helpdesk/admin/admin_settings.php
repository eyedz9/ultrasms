...
if ( defined('HESK_DEMO') )
{
	...
	$hesk_settings['server_path']		= $hesklang['hdemo'];
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td><?php echo defined('HESK_DEMO') ? $hesklang['hdemo'] : PHP_VERSION; ?></td>
	</tr>
	<tr>
...
<div class="tabber" id="tab1">
	...
	<div class="tabbertab">
		...
		<tr>
		<td style="text-align:right" width="200"><?php echo $hesklang['email_sup']; ?>: [<a href="Javascript:void(0)" onclick="Javascript:hesk_window('<?php echo $help_folder; ?>general.html#3','400','500')"><b>?</b></a>]</td>
		...
		<td><input type="text" name="s_db_host" id="m1" size="40" maxlength="255" value="<?php echo $hesk_settings['db_host']; ?>" /></td>
		</tr>
		<tr>
		...
		<td><input type="text" name="s_db_name" id="m2" size="40" maxlength="255" value="<?php echo $hesk_settings['db_name']; ?>" /></td>
		</tr>
		<tr>
		...
		<td><input type="text" name="s_db_user" id="m3" size="40" maxlength="255" value="<?php echo $hesk_settings['db_user']; ?>" /></td>
		</tr>
		<tr>
		...
		<td><input type="text" name="s_db_pfix" id="m5" size="40" maxlength="255" value="<?php echo $hesk_settings['db_pfix']; ?>" /></td>
		</tr>
		<tr>
	...
	<div class="tabbertab">
		...
		{
			$hesk_settings['server_path'] = getcwd();
		}
		?>
		...
		<tr>
		<td style="text-align:right" width="200"><?php echo $hesklang['hesk_path']; ?>: [<a href="Javascript:void(0)" onclick="Javascript:hesk_window('<?php echo $help_folder; ?>helpdesk.html#8','400','500')"><b>?</b></a>]</td>
		<td><input type="text" name="s_server_path" size="40" maxlength="255" value="<?php echo $hesk_settings['server_path']; ?>" />
		</td>
		</tr>
		<tr>
		...
		<td style="text-align:right" width="200"><?php echo $hesklang['use_secimg']; ?>: [<a href="Javascript:void(0)" onclick="Javascript:hesk_window('<?php echo $help_folder; ?>helpdesk.html#13','400','500')"><b>?</b></a>]</td>
		<td>
		<?php
	...
	<div class="tabbertab">
		...
		<td><input type="text" id="s4" name="s_smtp_user" size="40" maxlength="255" value="<?php echo $hesk_settings['smtp_user']; ?>" <?php echo $onload_status; ?> /></td>
		</tr>
		<tr>
		...
		echo '
		<label><input type="radio" name="s_pop3" value="0" onclick="hesk_attach_disable(new Array(\'p1\',\'p2\',\'p3\',\'p4\',\'p5\',\'p6\'))" onchange="hesk_toggleLayerDisplay(\'pop3_settings\');" '.$off.' /> '.$hesklang['off'].'</label> |
		<label><input type="radio" name="s_pop3" value="1" onclick="hesk_attach_enable(new Array(\'p1\',\'p2\',\'p3\',\'p4\',\'p5\',\'p6\'))" onchange="hesk_toggleLayerDisplay(\'pop3_settings\');"  '.$on.' /> '.$hesklang['on'].'</label>';
		?>
		...
		<td><input type="text" id="p5" name="s_pop3_user" size="40" maxlength="255" value="<?php echo $hesk_settings['pop3_user']; ?>" <?php echo $onload_status; ?> /></td>
		</tr>
		<tr>
	...
	while (false !== ($subdir = readdir($path)))
	{
		...
		if (filetype($dir . $subdir) == 'dir')
		{
	        ...
	        if (file_exists($langu))
	        {
	            ...
	            if (strpos($tmp,'$hesklang[\'updates2\']') === false)
	            {
